...
export function CountryLandingPage({ data }: { data: CountryLandingData }) {
  ...
  return (
    <div dir={ar ? 'rtl' : 'ltr'} className={ar ? 'font-arabic' : ''}>
        ...
        <div className="mx-auto grid max-w-wrap items-center gap-12 px-5 sm:px-7 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <Button href={ar ? '/ar/contact' : '/demo'} size="lg">{ar ? 'احجز عرضًا تجريبيًا' : 'Book a Demo'}</Button>
      ...
      <Section>
        <SectionHead eyebrow="FAQ" title={ar ? 'أسئلة شائعة' : 'Frequently asked questions'} />
